package es.ignapzs.hackerrank.java.algorithms.strings.richierich;

import java.util.Scanner;

public class Solution {
	private static String richieRich(String number, int n, int k) {
	...
	public static void main(String[] args) {
		...
		String result = richieRich(number, n, k);
